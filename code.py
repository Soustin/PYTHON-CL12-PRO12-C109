...
Fig = pff.create_distplot([reading_list], ["Reading-List"], show_hist = False)
Fig.add_trace(go.Scatter(x = [first_std_dev_start, first_std_dev_start], y = [0, 0.04], mode = "lines", name = "1ST STANDARD DEVIATION START"))
Fig.add_trace(go.Scatter(x = [first_std_dev_end, first_std_dev_end], y = [0, 0.04], mode = "lines", name = "1ST STANDARD DEVIATION END"))
Fig.add_trace(go.Scatter(x = [sec_std_dev_start, sec_std_dev_start], y = [0, 0.04], mode = "lines", name = "2ND STANDARD DEVIATION START"))
Fig.add_trace(go.Scatter(x = [sec_std_dev_start, sec_std_dev_start], y = [0, 0.04], mode = "lines", name = "2ND STANDARD DEVIATION END"))
Fig.add_trace(go.Scatter(x = [third_std_dev_start, third_std_dev_start], y = [0, 0.04], mode = "lines", name = "3RD STANDARD DEVIATION START"))
Fig.add_trace(go.Scatter(x = [third_std_dev_start, third_std_dev_start], y = [0, 0.04], mode = "lines", name = "3RD STANDARD DEVIATION END"))
